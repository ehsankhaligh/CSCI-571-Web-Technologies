    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                //Toast.makeText(getActivity().getApplicationContext(), "fetching hourly charts data ...", Toast.LENGTH_SHORT).show();
                view.loadUrl("javascript:getrecTrendChart("+uppercaseticker+", \"https://ehsankhalighstock.uw.r.appspot.com/api/v0/CompanyHistoricalDataSummary/"+MainActivity.getinputSymbol()+"\")");
        ...
        mWebView.loadUrl("file:///android_asset/hourchart.html");
        return v;
    }
}